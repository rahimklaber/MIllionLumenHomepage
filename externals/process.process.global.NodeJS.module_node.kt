...
external interface Process : EventEmitter {
    var stdout: WriteStream /* WriteStream & `T$10` */
    var stderr: WriteStream /* WriteStream & `T$11` */
    var stdin: ReadStream /* ReadStream & `T$12` */
    ...
    fun uptime(): Number
    var hrtime: HRTime
    val send: ((message: Any, sendHandle: Any, options: `T$14`, callback: (error: Error?) -> Unit) -> Boolean)?
    fun disconnect()
