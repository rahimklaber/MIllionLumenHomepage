...
external open class Socket(options: SocketConstructorOpts = definedExternally) : Duplex {
    ...
    override fun end()
    open fun end(buffer: Uint8Array, callback: () -> Unit = definedExternally)
    override fun end(chunk: Any, cb: () -> Unit)
    open fun end(buffer: Uint8Array)
    override fun end(chunk: Any)
    open fun end(buffer: String, callback: () -> Unit = definedExternally)
    open fun end(buffer: String)
    open fun end(str: Uint8Array, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally, callback: () -> Unit = definedExternally)
    ...
    open fun end(str: Uint8Array, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally)
    override fun end(chunk: Any, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */)
    open fun end(str: String, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally, callback: () -> Unit = definedExternally)
    open fun end(str: String, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally)
