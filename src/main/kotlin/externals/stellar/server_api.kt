...
//       var ledger: CallFunction<LedgerRecord>;
    ...
    interface PaymentOperationRecord : Horizon.PaymentOperationResponse,BaseOperationRecord, OperationRecord {
        var sender: () -> Promise<AccountRecord>
        var receiver: () -> Promise<AccountRecord>
    }

    interface ManageDataOperationRecord : Horizon.ManageDataOperationResponse, BaseOperationRecord, OperationRecord
