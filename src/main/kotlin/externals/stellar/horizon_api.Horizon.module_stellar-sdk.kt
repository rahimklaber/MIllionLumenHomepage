...
external interface BaseResponse {
    var _links: Any
}

external interface BaseResponse__0 : BaseResponse
...
external interface TransactionResponse : SubmitTransactionResponse, BaseResponse {
...
external interface AccountResponse : BaseResponse {
    var id: String
    var paging_token: String
...
external interface BaseOperationResponse : BaseResponse {
    var id: String
    var paging_token: String
    var source_account: String
    var type: OperationResponseType
    var type_i: OperationResponseTypeI
    var created_at: String
    var transaction_hash: String
}

external interface CreateAccountOperationResponse : BaseOperationResponse {
    var account: String
    var funder: String
    var starting_balance: String
}

external interface PaymentOperationResponse : BaseOperationResponse {
    var from: String
    var to: String
    var asset_type: Any
    var asset_code: String?
...
external interface PathPaymentOperationResponse : BaseOperationResponse {
    var amount: String
    var asset_code: String?
        get() = definedExternally
        set(value) = definedExternally
...
external interface PathPaymentStrictSendOperationResponse : BaseOperationResponse {
    var amount: String
    var asset_code: String?
        get() = definedExternally
        set(value) = definedExternally
...
external interface ManageOfferOperationResponse : BaseOperationResponse {
...
external interface PassiveOfferOperationResponse : BaseOperationResponse {
    var offer_id: dynamic /* Number | String */
        get() = definedExternally
        set(value) = definedExternally
    var amount: String
...
external interface SetOptionsOperationResponse : BaseOperationResponse {
...
external interface ChangeTrustOperationResponse : BaseOperationResponse {
...
external interface AllowTrustOperationResponse : BaseOperationResponse {
    var asset_type: Any
    var asset_code: String
    var asset_issuer: String
...
external interface AccountMergeOperationResponse : BaseOperationResponse {
    var into: String
}

external interface InflationOperationResponse : BaseOperationResponse

external interface ManageDataOperationResponse : BaseOperationResponse {
    var name: String
    var value: Buffer
}

external interface BumpSequenceOperationResponse : BaseOperationResponse {
    var bump_to: String
}
...
external interface CreateClaimableBalanceOperationResponse : BaseOperationResponse {
    var asset: String
    var amount: String
    var sponsor: String
...
external interface ClaimClaimableBalanceOperationResponse : BaseOperationResponse {
    var balance_id: String
    var claimant: String
}

external interface BeginSponsoringFutureReservesOperationResponse : BaseOperationResponse {
    var sponsored_id: String
}

external interface EndSponsoringFutureReservesOperationResponse : BaseOperationResponse {
    var begin_sponsor: String
}

external interface RevokeSponsorshipOperationResponse : BaseOperationResponse {
    var account_id: String?
        get() = definedExternally
        set(value) = definedExternally
...
external interface ClawbackOperationResponse : BaseOperationResponse {
    var asset_type: Any
    var asset_code: String
    var asset_issuer: String
    var from: String
...
external interface ClawbackClaimableBalanceOperationResponse : BaseOperationResponse {
    var balance_id: String
}

external interface SetTrustLineFlagsOperationResponse : BaseOperationResponse {
    var asset_type: Any
    var asset_code: String
    var asset_issuer: String
    var trustor: String
...
external interface ResponseCollection<T> {
    var _links: `T$16`
