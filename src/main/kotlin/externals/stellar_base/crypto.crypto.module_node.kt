...
external fun generateKey(type: String /* "hmac" | "aes" */, options: `T$54`, callback: (err: Error?, key: KeyObject) -> Unit)
...
external interface RSAKeyPairOptions<PubF : String, PrivF : String> {
    ...
    var publicExponent: Number?
        get() = definedExternally
        set(value) = definedExternally
    var publicKeyEncoding: `T$55`<Any?>
    var privateKeyEncoding: BasePrivateKeyEncodingOptions<PrivF> /* BasePrivateKeyEncodingOptions<PrivF> & `T$56` */
}

external interface `T$57`<PubF> {
...
external interface DSAKeyPairOptions<PubF : String, PrivF : String> {
    var modulusLength: Number
    var divisorLength: Number
    var publicKeyEncoding: `T$57`<Any?>
...
external fun diffieHellman(options: `T$64`): Buffer
