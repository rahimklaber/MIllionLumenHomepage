...
external interface EventSourceEventMap {
    var error: Event
...
external interface ReadableStream<R> {
    ...
    fun getReader(options: `T$3`): ReadableStreamBYOBReader
    fun getReader(): ReadableStreamDefaultReader<R>
    fun <T> pipeThrough(__0: `T$4`<R, T>, options: PipeOptions = definedExternally): ReadableStream<T>
...
external interface XPathEvaluatorBase {
    ...
    fun createExpression(expression: String, resolver: `T$5`? = definedExternally): XPathExpression
    fun createNSResolver(nodeResolver: Node): dynamic /* (prefix: String?) -> String? | `T$5` */
    ...
    fun evaluate(expression: String, contextNode: Node, resolver: `T$5`? = definedExternally, type: Number = definedExternally, result: XPathResult? = definedExternally): XPathResult
    fun evaluate(expression: String, contextNode: Node, resolver: `T$5`? = definedExternally): XPathResult
    fun evaluate(expression: String, contextNode: Node, resolver: `T$5`? = definedExternally, type: Number = definedExternally): XPathResult
}
