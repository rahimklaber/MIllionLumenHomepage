...
//        server.accounts().accountId("").call().await()
    ...
    fun imageView(pos: Point, size: Size, imageLink: String, linkToRedirectTo: String, onHoverText: String) = object : View() {
        init {
            this.position = pos
            this.size = size
...
//        for (y in 0 until 100) {
//            for (x in 0 until 100) {
//                val pos = position + Point(10 * x, y * 10)
//                if (!checkIfPointInChildren(pos, Size(10)))
//                    canvas.rect(
//                        Rectangle(pos, Size(10)),
