...
external interface ReadableStream : events.global.NodeJS.EventEmitter {
    ...
    fun <T : WritableStream> pipe(destination: T, options: `T$10` = definedExternally): T
...
external interface RequireResolve {
    @nativeInvoke
    operator fun invoke(id: String, options: `T$11` = definedExternally): String
...
external interface ProcessConfig {
    var target_defaults: process.global.NodeJS.`T$12`
    var variables: process.global.NodeJS.`T$13`
}
...
external interface Process : events.global.NodeJS.EventEmitter {
    var stdout: process.global.NodeJS.WriteStream /* WriteStream & `T$14` */
    var stderr: process.global.NodeJS.WriteStream /* WriteStream & `T$15` */
    var stdin: process.global.NodeJS.ReadStream /* ReadStream & `T$16` */
    ...
    var features: process.global.NodeJS.`T$17`
    fun umask(): Number
    fun umask(mask: String): Number
    fun umask(mask: Number): Number
    fun uptime(): Number
    var hrtime: process.global.NodeJS.HRTime
    val send: ((message: Any, sendHandle: Any, options: process.global.NodeJS.`T$18`, callback: (error: Error?) -> Unit) -> Boolean)?
    fun disconnect()
