...
external interface Process : EventEmitter {
    var stdout: WriteStream /* WriteStream & `T$14` */
    var stderr: WriteStream /* WriteStream & `T$15` */
    var stdin: ReadStream /* ReadStream & `T$16` */
    ...
    fun uptime(): Number
    var hrtime: HRTime
    val send: ((message: Any, sendHandle: Any, options: `T$18`, callback: (error: Error?) -> Unit) -> Boolean)?
    fun disconnect()
    ...
    fun addListener(event: String /* "uncaughtException" | "uncaughtExceptionMonitor" | "warning" */, listener: UncaughtExceptionListener): Process /* this */
    ...
    fun on(event: String /* "uncaughtException" | "uncaughtExceptionMonitor" | "warning" */, listener: UncaughtExceptionListener): Process /* this */
    ...
    fun once(event: String /* "uncaughtException" | "uncaughtExceptionMonitor" | "warning" */, listener: UncaughtExceptionListener): Process /* this */
    ...
    fun prependListener(event: String /* "uncaughtException" | "uncaughtExceptionMonitor" | "warning" */, listener: UncaughtExceptionListener): Process /* this */
    ...
    fun prependOnceListener(event: String /* "uncaughtException" | "uncaughtExceptionMonitor" | "warning" */, listener: UncaughtExceptionListener): Process /* this */
