...
external fun native(path: String, options: `T$41`): Buffer

external fun native(path: Buffer, options: String /* "buffer" */): Buffer

external fun native(path: Buffer, options: `T$41`): Buffer

external fun native(path: URL, options: String /* "buffer" */): Buffer

external fun native(path: URL, options: `T$41`): Buffer