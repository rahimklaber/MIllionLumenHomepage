...
external interface `T$34`<TBuffer> {
...
external interface FileHandle {
    ...
    fun readFile(options: `T$29`? = definedExternally): Promise<Buffer>
    fun readFile(): dynamic /* Promise */
    fun readFile(options: `T$30`): Promise<String>
    ...
    fun readFile(options: ObjectEncodingOptions /* ObjectEncodingOptions & `T$31` */ = definedExternally): Promise<dynamic /* String | Buffer */>
    fun stat(opts: StatOptions /* StatOptions & `T$32` | StatOptions & `T$33` */ = definedExternally): dynamic /* Promise */
    ...
    fun <TBuffer : Uint8Array> write(buffer: TBuffer, offset: Number? = definedExternally, length: Number? = definedExternally, position: Number? = definedExternally): Promise<`T$34`<TBuffer>>
    fun <TBuffer : Uint8Array> write(buffer: TBuffer): Promise<`T$34`<TBuffer>>
    fun <TBuffer : Uint8Array> write(buffer: TBuffer, offset: Number? = definedExternally): Promise<`T$34`<TBuffer>>
    fun <TBuffer : Uint8Array> write(buffer: TBuffer, offset: Number? = definedExternally, length: Number? = definedExternally): Promise<`T$34`<TBuffer>>
    fun write(data: String, position: Number? = definedExternally, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): Promise<`T$35`>
    fun write(data: String): Promise<`T$35`>
    fun write(data: String, position: Number? = definedExternally): Promise<`T$35`>
...
external fun mkdir(path: String, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$36` | MakeDirectoryOptions & `T$37` */): dynamic /* Promise | Promise */

external fun mkdir(path: Buffer, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$36` | MakeDirectoryOptions & `T$37` */): dynamic /* Promise | Promise */

external fun mkdir(path: URL, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$36` | MakeDirectoryOptions & `T$37` */): dynamic /* Promise | Promise */
...
external fun readdir(path: String, options: Any? /* ObjectEncodingOptions & `T$38` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): dynamic /* Promise | Promise */

external fun readdir(path: String): dynamic /* Promise | Promise */

external fun readdir(path: Buffer, options: Any? /* ObjectEncodingOptions & `T$38` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): dynamic /* Promise | Promise */

external fun readdir(path: Buffer): dynamic /* Promise | Promise */

external fun readdir(path: URL, options: Any? /* ObjectEncodingOptions & `T$38` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): dynamic /* Promise | Promise */
...
external fun readdir(path: String, options: `T$39`): Promise<Array<Buffer>>

external fun readdir(path: String, options: String /* "buffer" */): Promise<Array<Buffer>>

external fun readdir(path: Buffer, options: `T$39`): Promise<Array<Buffer>>

external fun readdir(path: Buffer, options: String /* "buffer" */): Promise<Array<Buffer>>

external fun readdir(path: URL, options: `T$39`): Promise<Array<Buffer>>
...
external fun readdir(path: String, options: ObjectEncodingOptions /* ObjectEncodingOptions & `T$40` */): Promise<Array<Dirent>>

external fun readdir(path: Buffer, options: ObjectEncodingOptions /* ObjectEncodingOptions & `T$40` */): Promise<Array<Dirent>>

external fun readdir(path: URL, options: ObjectEncodingOptions /* ObjectEncodingOptions & `T$40` */): Promise<Array<Dirent>>
...
external fun readlink(path: String, options: `T$42`): Promise<Buffer>

external fun readlink(path: Buffer, options: String /* "buffer" */): Promise<Buffer>

external fun readlink(path: Buffer, options: `T$42`): Promise<Buffer>

external fun readlink(path: URL, options: String /* "buffer" */): Promise<Buffer>

external fun readlink(path: URL, options: `T$42`): Promise<Buffer>
...
external fun lstat(path: String, opts: StatOptions /* StatOptions & `T$32` | StatOptions & `T$33` */ = definedExternally): dynamic /* Promise */

external fun lstat(path: String): dynamic /* Promise | Promise */

external fun lstat(path: Buffer, opts: StatOptions /* StatOptions & `T$32` | StatOptions & `T$33` */ = definedExternally): dynamic /* Promise */

external fun lstat(path: Buffer): dynamic /* Promise | Promise */

external fun lstat(path: URL, opts: StatOptions /* StatOptions & `T$32` | StatOptions & `T$33` */ = definedExternally): dynamic /* Promise */

external fun lstat(path: URL): dynamic /* Promise | Promise */

external fun stat(path: String, opts: StatOptions /* StatOptions & `T$32` | StatOptions & `T$33` */ = definedExternally): dynamic /* Promise */

external fun stat(path: String): dynamic /* Promise | Promise */

external fun stat(path: Buffer, opts: StatOptions /* StatOptions & `T$32` | StatOptions & `T$33` */ = definedExternally): dynamic /* Promise */

external fun stat(path: Buffer): dynamic /* Promise | Promise */

external fun stat(path: URL, opts: StatOptions /* StatOptions & `T$32` | StatOptions & `T$33` */ = definedExternally): dynamic /* Promise */
...
external fun realpath(path: String, options: `T$42`): Promise<Buffer>

external fun realpath(path: Buffer, options: String /* "buffer" */): Promise<Buffer>

external fun realpath(path: Buffer, options: `T$42`): Promise<Buffer>

external fun realpath(path: URL, options: String /* "buffer" */): Promise<Buffer>

external fun realpath(path: URL, options: `T$42`): Promise<Buffer>
...
external fun mkdtemp(prefix: String, options: `T$42`): Promise<Buffer>
...
external fun readFile(path: String, options: `T$29` /* `T$29` & Abortable */ = definedExternally): Promise<Buffer>

external fun readFile(path: String): dynamic /* Promise | Promise */

external fun readFile(path: Buffer, options: `T$29` /* `T$29` & Abortable */ = definedExternally): Promise<Buffer>

external fun readFile(path: Buffer): dynamic /* Promise | Promise */

external fun readFile(path: URL, options: `T$29` /* `T$29` & Abortable */ = definedExternally): Promise<Buffer>

external fun readFile(path: URL): dynamic /* Promise | Promise */

external fun readFile(path: FileHandle, options: `T$29` /* `T$29` & Abortable */ = definedExternally): Promise<Buffer>

external fun readFile(path: FileHandle): dynamic /* Promise | Promise */

external fun readFile(path: String, options: Any /* `T$30` & Abortable | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */): Promise<String>

external fun readFile(path: Buffer, options: Any /* `T$30` & Abortable | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */): Promise<String>

external fun readFile(path: URL, options: Any /* `T$30` & Abortable | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */): Promise<String>

external fun readFile(path: FileHandle, options: Any /* `T$30` & Abortable | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */): Promise<String>

external fun readFile(path: String, options: Any? /* ObjectEncodingOptions & Abortable & `T$31` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): Promise<dynamic /* String | Buffer */>

external fun readFile(path: Buffer, options: Any? /* ObjectEncodingOptions & Abortable & `T$31` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): Promise<dynamic /* String | Buffer */>

external fun readFile(path: URL, options: Any? /* ObjectEncodingOptions & Abortable & `T$31` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): Promise<dynamic /* String | Buffer */>

external fun readFile(path: FileHandle, options: Any? /* ObjectEncodingOptions & Abortable & `T$31` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): Promise<dynamic /* String | Buffer */>
...
external fun watch(filename: String, options: WatchOptions /* WatchOptions & `T$42` */): dynamic /* AsyncIterable */

external fun watch(filename: String, options: String /* "buffer" */): dynamic /* AsyncIterable */

external fun watch(filename: Buffer, options: WatchOptions /* WatchOptions & `T$42` */): dynamic /* AsyncIterable */

external fun watch(filename: Buffer, options: String /* "buffer" */): dynamic /* AsyncIterable */

external fun watch(filename: URL, options: WatchOptions /* WatchOptions & `T$42` */): dynamic /* AsyncIterable */

external fun watch(filename: URL, options: String /* "buffer" */): dynamic /* AsyncIterable */

external fun watch(filename: String, options: Any /* WatchOptions | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): AsyncIterable<String>

external fun watch(filename: String): AsyncIterable<String>

external fun watch(filename: Buffer, options: Any /* WatchOptions | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): AsyncIterable<String>

external fun watch(filename: Buffer): AsyncIterable<String>

external fun watch(filename: URL, options: Any /* WatchOptions | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): AsyncIterable<String>

external fun watch(filename: URL): AsyncIterable<String>