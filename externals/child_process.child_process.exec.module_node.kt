...
external fun __promisify__(command: String, options: `T$70` /* `T$70` & ExecOptions */): PromiseWithChild<`T$73`>

external fun __promisify__(command: String, options: `T$71` /* `T$71` & ExecOptions */): PromiseWithChild<`T$72`>

external fun __promisify__(command: String, options: ExecOptions): PromiseWithChild<`T$72`>
...
external fun __promisify__(command: String, options: ObjectEncodingOptions /* ObjectEncodingOptions & ExecOptions */ = definedExternally): PromiseWithChild<`T$74`>