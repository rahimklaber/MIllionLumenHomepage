...
external fun __promisify__(path: String, options: `T$41`): Promise<Buffer>

external fun __promisify__(path: Buffer, options: String /* "buffer" */): Promise<Buffer>

external fun __promisify__(path: Buffer, options: `T$41`): Promise<Buffer>

external fun __promisify__(path: URL, options: String /* "buffer" */): Promise<Buffer>

external fun __promisify__(path: URL, options: `T$41`): Promise<Buffer>
...
external fun native(path: String, options: `T$41`, callback: (err: ErrnoException?, resolvedPath: Buffer) -> Unit)

external fun native(path: Buffer, options: String /* "buffer" */, callback: (err: ErrnoException?, resolvedPath: Buffer) -> Unit)

external fun native(path: Buffer, options: `T$41`, callback: (err: ErrnoException?, resolvedPath: Buffer) -> Unit)

external fun native(path: URL, options: String /* "buffer" */, callback: (err: ErrnoException?, resolvedPath: Buffer) -> Unit)

external fun native(path: URL, options: `T$41`, callback: (err: ErrnoException?, resolvedPath: Buffer) -> Unit)
