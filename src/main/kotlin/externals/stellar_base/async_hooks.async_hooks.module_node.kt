...
external open class AsyncResource {
    ...
    open fun <Func : (args: Any) -> Any> bind(fn: Func): Func /* Func & `T$68` */
    ...
    companion object {
        fun <Func : (self: ThisArg, args: Any) -> Any, ThisArg> bind(fn: Func, type: String = definedExternally, thisArg: ThisArg = definedExternally): Func /* Func & `T$68` */
    }
}
