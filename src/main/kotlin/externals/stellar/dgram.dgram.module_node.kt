...
external open class Socket : EventEmitter {
    ...
    open fun bind()
    open fun bind(port: Number = definedExternally)
    open fun bind(port: Number = definedExternally, address: String = definedExternally)
    ...
    open fun bind(options: BindOptions)
