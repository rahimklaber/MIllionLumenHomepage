...
external fun __promisify__(path: String, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$35` | MakeDirectoryOptions & `T$36` */): dynamic /* Promise | Promise */

external fun __promisify__(path: Buffer, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$35` | MakeDirectoryOptions & `T$36` */): dynamic /* Promise | Promise */

external fun __promisify__(path: URL, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$35` | MakeDirectoryOptions & `T$36` */): dynamic /* Promise | Promise */
