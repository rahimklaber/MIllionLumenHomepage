...
external open class internal : EventEmitter {
    open fun <T : WritableStream> pipe(destination: T, options: `T$10` = definedExternally): T
    ...
    interface WritableOptions : StreamOptions<Writable> {
        ...
        val writev: ((chunks: Array<`T$21`>, callback: (error: Error?) -> Unit) -> Unit)?
    ...
    open class Writable(opts: WritableOptions = definedExternally) : Stream, WritableStream {
        ...
        open val _writev: ((chunks: Array<`T$21`>, callback: (error: Error?) -> Unit) -> Unit)?
        open val _construct: ((callback: (error: Error?) -> Unit) -> Unit)?
        open fun _destroy(error: Error?, callback: (error: Error?) -> Unit)
        ...
        open fun end(chunk: Any)
        override fun end(data: String)
        override fun end(data: Uint8Array)
        open fun end(chunk: Any, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, cb: () -> Unit = definedExternally)
        override fun end(str: String, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, cb: () -> Unit)
        open fun end(chunk: Any, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */)
        override fun end(str: String, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */)
        open fun cork()
        open fun uncork()
        open fun destroy(error: Error = definedExternally)
    ...
    open class Duplex(opts: DuplexOptions = definedExternally) : Readable {
        ...
        open fun end(chunk: Any, cb: () -> Unit = definedExternally)
        open fun end(chunk: Any)
        open fun end(chunk: Any, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally, cb: () -> Unit = definedExternally)
        open fun end(chunk: Any, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally)
        open fun cork()
        open fun uncork()
    }
    interface TransformOptions : DuplexOptions {
        ...
        override val writev: ((chunks: Array<`T$21`>, callback: (error: Error?) -> Unit) -> Unit)?
