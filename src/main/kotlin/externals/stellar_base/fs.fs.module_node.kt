...
import url.URL
import fs.promises.`T$41`
import fs.promises.`T$38`
...
external fun readlink(path: String, options: `T$41`, callback: (err: ErrnoException?, linkString: Buffer) -> Unit)

external fun readlink(path: Buffer, options: String /* "buffer" */, callback: (err: ErrnoException?, linkString: Buffer) -> Unit)

external fun readlink(path: Buffer, options: `T$41`, callback: (err: ErrnoException?, linkString: Buffer) -> Unit)

external fun readlink(path: URL, options: String /* "buffer" */, callback: (err: ErrnoException?, linkString: Buffer) -> Unit)

external fun readlink(path: URL, options: `T$41`, callback: (err: ErrnoException?, linkString: Buffer) -> Unit)
...
external fun readlinkSync(path: String, options: `T$41`): Buffer

external fun readlinkSync(path: Buffer, options: String /* "buffer" */): Buffer

external fun readlinkSync(path: Buffer, options: `T$41`): Buffer

external fun readlinkSync(path: URL, options: String /* "buffer" */): Buffer

external fun readlinkSync(path: URL, options: `T$41`): Buffer
...
external fun realpath(path: String, options: `T$41`, callback: (err: ErrnoException?, resolvedPath: Buffer) -> Unit)

external fun realpath(path: Buffer, options: String /* "buffer" */, callback: (err: ErrnoException?, resolvedPath: Buffer) -> Unit)

external fun realpath(path: Buffer, options: `T$41`, callback: (err: ErrnoException?, resolvedPath: Buffer) -> Unit)

external fun realpath(path: URL, options: String /* "buffer" */, callback: (err: ErrnoException?, resolvedPath: Buffer) -> Unit)

external fun realpath(path: URL, options: `T$41`, callback: (err: ErrnoException?, resolvedPath: Buffer) -> Unit)
...
external fun realpathSync(path: String, options: `T$41`): Buffer

external fun realpathSync(path: Buffer, options: String /* "buffer" */): Buffer

external fun realpathSync(path: Buffer, options: `T$41`): Buffer

external fun realpathSync(path: URL, options: String /* "buffer" */): Buffer

external fun realpathSync(path: URL, options: `T$41`): Buffer
...
external fun mkdir(path: String, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$35` */, callback: (err: ErrnoException?, path: String) -> Unit)

external fun mkdir(path: Buffer, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$35` */, callback: (err: ErrnoException?, path: String) -> Unit)

external fun mkdir(path: URL, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$35` */, callback: (err: ErrnoException?, path: String) -> Unit)
...
external fun mkdir(path: String, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$36` */, callback: NoParamCallback)
...
external fun mkdir(path: Buffer, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$36` */, callback: NoParamCallback)
...
external fun mkdir(path: URL, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$36` */, callback: NoParamCallback)
...
external fun mkdirSync(path: String, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$35` | MakeDirectoryOptions & `T$36` */): dynamic /* String | Unit */

external fun mkdirSync(path: Buffer, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$35` | MakeDirectoryOptions & `T$36` */): dynamic /* String | Unit */

external fun mkdirSync(path: URL, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$35` | MakeDirectoryOptions & `T$36` */): dynamic /* String | Unit */
...
external fun mkdtemp(prefix: String, options: `T$41`, callback: (err: ErrnoException?, folder: Buffer) -> Unit)
...
external fun mkdtempSync(prefix: String, options: `T$41`): Buffer
...
external fun readdir(path: String, options: Any? /* `T$45`? | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: (err: ErrnoException?, files: Array<String>) -> Unit)

external fun readdir(path: Buffer, options: Any? /* `T$45`? | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: (err: ErrnoException?, files: Array<String>) -> Unit)

external fun readdir(path: URL, options: Any? /* `T$45`? | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: (err: ErrnoException?, files: Array<String>) -> Unit)

external fun readdir(path: String, options: `T$38`, callback: (err: ErrnoException?, files: Array<Buffer>) -> Unit)

external fun readdir(path: String, options: String /* "buffer" */, callback: (err: ErrnoException?, files: Array<Buffer>) -> Unit)

external fun readdir(path: Buffer, options: `T$38`, callback: (err: ErrnoException?, files: Array<Buffer>) -> Unit)

external fun readdir(path: Buffer, options: String /* "buffer" */, callback: (err: ErrnoException?, files: Array<Buffer>) -> Unit)

external fun readdir(path: URL, options: `T$38`, callback: (err: ErrnoException?, files: Array<Buffer>) -> Unit)

external fun readdir(path: URL, options: String /* "buffer" */, callback: (err: ErrnoException?, files: Array<Buffer>) -> Unit)

external fun readdir(path: String, options: Any? /* ObjectEncodingOptions & `T$37` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: (err: ErrnoException?, files: Any /* Array<String> | Array<Buffer> */) -> Unit)

external fun readdir(path: Buffer, options: Any? /* ObjectEncodingOptions & `T$37` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: (err: ErrnoException?, files: Any /* Array<String> | Array<Buffer> */) -> Unit)

external fun readdir(path: URL, options: Any? /* ObjectEncodingOptions & `T$37` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: (err: ErrnoException?, files: Any /* Array<String> | Array<Buffer> */) -> Unit)
...
external fun readdir(path: String, options: ObjectEncodingOptions /* ObjectEncodingOptions & `T$39` */, callback: (err: ErrnoException?, files: Array<Dirent>) -> Unit)

external fun readdir(path: Buffer, options: ObjectEncodingOptions /* ObjectEncodingOptions & `T$39` */, callback: (err: ErrnoException?, files: Array<Dirent>) -> Unit)

external fun readdir(path: URL, options: ObjectEncodingOptions /* ObjectEncodingOptions & `T$39` */, callback: (err: ErrnoException?, files: Array<Dirent>) -> Unit)

external fun readdirSync(path: String, options: Any? /* `T$45`? | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" | ObjectEncodingOptions & `T$37` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): dynamic /* Array */

external fun readdirSync(path: String): dynamic /* Array */

external fun readdirSync(path: Buffer, options: Any? /* `T$45`? | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" | ObjectEncodingOptions & `T$37` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): dynamic /* Array */

external fun readdirSync(path: Buffer): dynamic /* Array */

external fun readdirSync(path: URL, options: Any? /* `T$45`? | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" | ObjectEncodingOptions & `T$37` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): dynamic /* Array */

external fun readdirSync(path: URL): dynamic /* Array */

external fun readdirSync(path: String, options: `T$38`): Array<Buffer>

external fun readdirSync(path: String, options: String /* "buffer" */): Array<Buffer>

external fun readdirSync(path: Buffer, options: `T$38`): Array<Buffer>

external fun readdirSync(path: Buffer, options: String /* "buffer" */): Array<Buffer>

external fun readdirSync(path: URL, options: `T$38`): Array<Buffer>

external fun readdirSync(path: URL, options: String /* "buffer" */): Array<Buffer>

external fun readdirSync(path: String, options: ObjectEncodingOptions /* ObjectEncodingOptions & `T$39` */): Array<Dirent>

external fun readdirSync(path: Buffer, options: ObjectEncodingOptions /* ObjectEncodingOptions & `T$39` */): Array<Dirent>

external fun readdirSync(path: URL, options: ObjectEncodingOptions /* ObjectEncodingOptions & `T$39` */): Array<Dirent>
...
external fun readFile(path: String, options: `T$47` /* `T$47` & Abortable */, callback: (err: ErrnoException?, data: Buffer) -> Unit)

external fun readFile(path: Buffer, options: `T$47` /* `T$47` & Abortable */, callback: (err: ErrnoException?, data: Buffer) -> Unit)

external fun readFile(path: URL, options: `T$47` /* `T$47` & Abortable */, callback: (err: ErrnoException?, data: Buffer) -> Unit)

external fun readFile(path: Number, options: `T$47` /* `T$47` & Abortable */, callback: (err: ErrnoException?, data: Buffer) -> Unit)
...
external fun readFile(path: String, options: Any /* `T$48` & Abortable | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: (err: ErrnoException?, data: String) -> Unit)

external fun readFile(path: Buffer, options: Any /* `T$48` & Abortable | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: (err: ErrnoException?, data: String) -> Unit)

external fun readFile(path: URL, options: Any /* `T$48` & Abortable | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: (err: ErrnoException?, data: String) -> Unit)

external fun readFile(path: Number, options: Any /* `T$48` & Abortable | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: (err: ErrnoException?, data: String) -> Unit)
...
external fun readFile(path: String, options: Any? /* ObjectEncodingOptions & `T$49` & Abortable | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: (err: ErrnoException?, data: Any /* String | Buffer */) -> Unit)

external fun readFile(path: Buffer, options: Any? /* ObjectEncodingOptions & `T$49` & Abortable | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: (err: ErrnoException?, data: Any /* String | Buffer */) -> Unit)

external fun readFile(path: URL, options: Any? /* ObjectEncodingOptions & `T$49` & Abortable | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: (err: ErrnoException?, data: Any /* String | Buffer */) -> Unit)

external fun readFile(path: Number, options: Any? /* ObjectEncodingOptions & `T$49` & Abortable | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: (err: ErrnoException?, data: Any /* String | Buffer */) -> Unit)
...
external fun readFileSync(path: String, options: `T$47`? = definedExternally): Buffer

external fun readFileSync(path: String): dynamic /* Buffer */

external fun readFileSync(path: Buffer, options: `T$47`? = definedExternally): Buffer

external fun readFileSync(path: Buffer): dynamic /* Buffer */

external fun readFileSync(path: URL, options: `T$47`? = definedExternally): Buffer

external fun readFileSync(path: URL): dynamic /* Buffer */

external fun readFileSync(path: Number, options: `T$47`? = definedExternally): Buffer

external fun readFileSync(path: Number): dynamic /* Buffer */

external fun readFileSync(path: String, options: Any /* `T$48` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */): String

external fun readFileSync(path: Buffer, options: Any /* `T$48` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */): String

external fun readFileSync(path: URL, options: Any /* `T$48` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */): String

external fun readFileSync(path: Number, options: Any /* `T$48` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */): String

external fun readFileSync(path: String, options: Any? /* ObjectEncodingOptions & `T$49` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): dynamic /* String | Buffer */

external fun readFileSync(path: Buffer, options: Any? /* ObjectEncodingOptions & `T$49` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): dynamic /* String | Buffer */

external fun readFileSync(path: URL, options: Any? /* ObjectEncodingOptions & `T$49` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): dynamic /* String | Buffer */

external fun readFileSync(path: Number, options: Any? /* ObjectEncodingOptions & `T$49` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): dynamic /* String | Buffer */
...
external fun writeFile(file: String, data: Any /* String | Uint8Array | Uint8ClampedArray | Uint16Array | Uint32Array | Int8Array | Int16Array | Int32Array | BigUint64Array | BigInt64Array | Float32Array | Float64Array | DataView */, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: NoParamCallback)
...
external fun writeFileSync(file: String, data: Any /* String | Uint8Array | Uint8ClampedArray | Uint16Array | Uint32Array | Int8Array | Int16Array | Int32Array | BigUint64Array | BigInt64Array | Float32Array | Float64Array | DataView */, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally)
...
external fun appendFile(path: String, data: String, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: NoParamCallback)

external fun appendFile(path: String, data: Uint8Array, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: NoParamCallback)

external fun appendFile(path: Buffer, data: String, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: NoParamCallback)

external fun appendFile(path: Buffer, data: Uint8Array, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: NoParamCallback)

external fun appendFile(path: URL, data: String, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: NoParamCallback)

external fun appendFile(path: URL, data: Uint8Array, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: NoParamCallback)

external fun appendFile(path: Number, data: String, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: NoParamCallback)

external fun appendFile(path: Number, data: Uint8Array, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */, callback: NoParamCallback)
...
external fun appendFileSync(path: String, data: String, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally)

external fun appendFileSync(path: String, data: String)

external fun appendFileSync(path: String, data: Uint8Array, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally)

external fun appendFileSync(path: String, data: Uint8Array)

external fun appendFileSync(path: Buffer, data: String, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally)

external fun appendFileSync(path: Buffer, data: String)

external fun appendFileSync(path: Buffer, data: Uint8Array, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally)

external fun appendFileSync(path: Buffer, data: Uint8Array)

external fun appendFileSync(path: URL, data: String, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally)

external fun appendFileSync(path: URL, data: String)

external fun appendFileSync(path: URL, data: Uint8Array, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally)

external fun appendFileSync(path: URL, data: Uint8Array)

external fun appendFileSync(path: Number, data: String, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally)

external fun appendFileSync(path: Number, data: String)

external fun appendFileSync(path: Number, data: Uint8Array, options: Any? /* ObjectEncodingOptions & Abortable & `T$50` | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally)
...
external fun watchFile(filename: String, options: `T$51`?, listener: (curr: Stats, prev: Stats) -> Unit)

external fun watchFile(filename: Buffer, options: `T$51`?, listener: (curr: Stats, prev: Stats) -> Unit)

external fun watchFile(filename: URL, options: `T$51`?, listener: (curr: Stats, prev: Stats) -> Unit)
...
external fun watch(filename: String, options: WatchOptions /* WatchOptions & `T$41` */, listener: WatchListener<Buffer> = definedExternally): FSWatcher

external fun watch(filename: String, options: WatchOptions /* WatchOptions & `T$41` */): FSWatcher
...
external fun watch(filename: Buffer, options: WatchOptions /* WatchOptions & `T$41` */, listener: WatchListener<Buffer> = definedExternally): FSWatcher

external fun watch(filename: Buffer, options: WatchOptions /* WatchOptions & `T$41` */): FSWatcher
...
external fun watch(filename: URL, options: WatchOptions /* WatchOptions & `T$41` */, listener: WatchListener<Buffer> = definedExternally): FSWatcher

external fun watch(filename: URL, options: WatchOptions /* WatchOptions & `T$41` */): FSWatcher
