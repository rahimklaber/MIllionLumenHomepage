...
import org.w3c.xhr.*
import URI.QueryDataMap
import URI.URIOptions
...
external interface URI {
    ...
    fun href(): String
    fun href(url: String)
    fun `is`(qry: String /* "relative" | "absolute" | "urn" | "url" | "domain" | "name" | "sld" | "idn" | "punycode" | "ip" | "ip4" | "ipv4" | "inet4" | "ip6" | "ipv6" | "inet6" */): Boolean
    fun iso8859(): URI
    fun normalize(): URI
    ...
    fun setQuery(key: String, value: String): URI
    fun setQuery(qry: Any?): URI
    fun setSearch(key: String, value: String): URI
    fun setSearch(qry: Any?): URI
    fun hasQuery(name: Any, value: String = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasQuery(name: Any): Boolean
    fun hasQuery(name: Any, value: String = definedExternally): Boolean
    fun hasQuery(name: Any, value: Number = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasQuery(name: Any, value: Number = definedExternally): Boolean
    fun hasQuery(name: Any, value: Boolean = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasQuery(name: Any, value: Boolean = definedExternally): Boolean
    fun hasQuery(name: Any, value: Array<String> = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasQuery(name: Any, value: Array<String> = definedExternally): Boolean
    fun hasQuery(name: Any, value: Array<Number> = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasQuery(name: Any, value: Array<Number> = definedExternally): Boolean
    fun hasQuery(name: Any, value: Array<Boolean> = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasQuery(name: Any, value: Array<Boolean> = definedExternally): Boolean
    fun hasQuery(name: Any, value: RegExp = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasQuery(name: Any, value: RegExp = definedExternally): Boolean
    fun hasQuery(name: Any, value: (args: Any) -> Any = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasQuery(name: Any, value: (args: Any) -> Any = definedExternally): Boolean
    fun hasSearch(name: Any, value: String = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasSearch(name: Any): Boolean
    fun hasSearch(name: Any, value: String = definedExternally): Boolean
    fun hasSearch(name: Any, value: Number = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasSearch(name: Any, value: Number = definedExternally): Boolean
    fun hasSearch(name: Any, value: Boolean = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasSearch(name: Any, value: Boolean = definedExternally): Boolean
    fun hasSearch(name: Any, value: Array<String> = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasSearch(name: Any, value: Array<String> = definedExternally): Boolean
    fun hasSearch(name: Any, value: Array<Number> = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasSearch(name: Any, value: Array<Number> = definedExternally): Boolean
    fun hasSearch(name: Any, value: Array<Boolean> = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasSearch(name: Any, value: Array<Boolean> = definedExternally): Boolean
    fun hasSearch(name: Any, value: RegExp = definedExternally, withinArray: Boolean = definedExternally): Boolean
    fun hasSearch(name: Any, value: RegExp = definedExternally): Boolean
    fun hasSearch(name: Any, value: (args: Any) -> Any = definedExternally, withinArray: Boolean = definedExternally): Boolean
