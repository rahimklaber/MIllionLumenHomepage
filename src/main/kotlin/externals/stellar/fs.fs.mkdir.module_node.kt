...
external fun __promisify__(path: String, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$36` | MakeDirectoryOptions & `T$37` */): dynamic /* Promise | Promise */

external fun __promisify__(path: Buffer, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$36` | MakeDirectoryOptions & `T$37` */): dynamic /* Promise | Promise */

external fun __promisify__(path: URL, options: MakeDirectoryOptions /* MakeDirectoryOptions & `T$36` | MakeDirectoryOptions & `T$37` */): dynamic /* Promise | Promise */
