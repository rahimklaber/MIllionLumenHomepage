...
external interface BufferConstructor {
    ...
    fun from(arrayBuffer: `T$22`<Any /* ArrayBuffer | SharedArrayBuffer */>, byteOffset: Number = definedExternally, length: Number = definedExternally): Buffer
    fun from(arrayBuffer: `T$22`<Any /* ArrayBuffer | SharedArrayBuffer | Uint8Array | ReadonlyArray<Number> | String */>): Buffer
    fun from(arrayBuffer: `T$22`<Any /* ArrayBuffer | SharedArrayBuffer */>, byteOffset: Number = definedExternally): Buffer
    ...
    fun from(str: `T$22`<String>, encoding: String /* "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex" */ = definedExternally): Buffer
    fun from(str: `T$22`<String>): Buffer
