...
external fun exec(command: String, options: `T$70` /* `T$70` & ExecOptions */, callback: (error: ExecException?, stdout: Buffer, stderr: Buffer) -> Unit = definedExternally): ChildProcess
...
external fun exec(command: String, options: `T$71` /* `T$71` & ExecOptions */, callback: (error: ExecException?, stdout: String, stderr: String) -> Unit = definedExternally): ChildProcess

external fun exec(command: String, options: `T$71` /* `T$71` & ExecOptions */): ChildProcess

external fun exec(command: String, options: `T$71` /* `T$71` & ExecOptions */, callback: (error: ExecException?, stdout: Any /* String | Buffer */, stderr: Any /* String | Buffer */) -> Unit = definedExternally): ChildProcess
